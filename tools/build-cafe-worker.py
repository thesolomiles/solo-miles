"""
Merge the café worker's FBX pose clips (Mixamo) into ONE Draco GLB used
for the two ambient baristas behind the café counter.
...
Add a pose later: drop another Mixamo .fbx in assets/characters/cafe-worker/ and
...
NAME_MAP = {
    ...
    "Female Walk": "walk",       # loop: walking (unused by the static barista)
}
